...
public class RPNCalculatorTest {
    ...
    @Test
    public void processFormulaPrimeSumOne() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(3);
        final int expected = 17;
        String input = "2 7 @";
        final int actual = calculator.processFormula(input);
    ...
    @Test
    public void processFormulaPrimeSumTwo() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(3);
    ...
    @Test
    public void processFormulaPrimeSumThree() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(3);
        final int expected = 1060;
        String input = "1 100 @";
        final int actual = calculator.processFormula(input);
        assertEquals(expected, actual);
    }
    ...
    @Test
    public void processFormulaPrimeSumNegative() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(3);
        final int expected = 0;
        String input = "-2 -7 @";
        final int actual = calculator.processFormula(input);
    ...
    @Test
    public void processFormulaPrimeSumZeroesAndOnes() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(3);
        final int expected = 0;
        String input = "0 1 @";
        final int actual = calculator.processFormula(input);
